...
public class ListarCursosView extends javax.swing.JFrame {
    ...
    public void configurarTabelaNaoEditavel() {
        DefaultTableModel model = new DefaultTableModel(
            new Object[][]{},
            new String[]{"ID", "Nome", "Carga Horária", "Qtd de Alunos"}
        ) {
            @Override
    ...
    private void initComponents() {
        ...
        btnEditarView.setBackground(new java.awt.Color(19, 31, 38));
        btnEditarView.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnEditarView.setForeground(new java.awt.Color(217, 217, 217));
        ...
        btnExcluirView.setBackground(new java.awt.Color(19, 31, 38));
        btnExcluirView.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnExcluirView.setForeground(new java.awt.Color(217, 217, 217));
        ...
        btnConsultarCursoView.setBackground(new java.awt.Color(19, 31, 38));
        btnConsultarCursoView.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnConsultarCursoView.setForeground(new java.awt.Color(217, 217, 217));
        ...
        btnExportarCursos.setBackground(new java.awt.Color(19, 31, 38));
        btnExportarCursos.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnExportarCursos.setForeground(new java.awt.Color(217, 217, 217));

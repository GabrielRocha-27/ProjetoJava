...
public class ListarAlunosView extends javax.swing.JFrame {
    ...
    public void configurarTabelaNaoEditavel() {
        DefaultTableModel model = new DefaultTableModel(
            new Object[][]{},
            new String[]{"ID", "Nome", "Email", "CPF", "Nascimento", "Curso"}
        ) {
            @Override
    ...
    private void initComponents() {
        ...
        btnEditarAluno.setBackground(new java.awt.Color(19, 31, 38));
        btnEditarAluno.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnEditarAluno.setForeground(new java.awt.Color(217, 217, 217));
        ...
        btnExcluirAluno.setBackground(new java.awt.Color(19, 31, 38));
        btnExcluirAluno.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnExcluirAluno.setForeground(new java.awt.Color(217, 217, 217));
        ...
        btnExportarAlunos.setBackground(new java.awt.Color(19, 31, 38));
        btnExportarAlunos.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnExportarAlunos.setForeground(new java.awt.Color(217, 217, 217));

...
public class AlunoDAO {
    ...
    public void inserir(Aluno aluno) throws SQLException {
        String sql = "INSERT INTO aluno (cpf, nome, email, data_nascimento, curso_id) VALUES (?, ?, ?, ?, ?)";
    ...
    public int contarAlunosPorCurso(int cursoId) throws SQLException {
        ...
        String sql = "SELECT COUNT(*) FROM aluno WHERE curso_id = ?";
        PreparedStatement stmt = conn.prepareStatement(sql);
    ...
    String sqlCount = "SELECT COUNT(*) AS total FROM aluno WHERE curso_id = ?";
    String sqlLimit = "SELECT limite_alunos FROM curso WHERE id = ?";
    String sqlInsert = "INSERT INTO aluno (cpf, nome, email, data_nascimento, curso_id) VALUES (?, ?, ?, ?, ?)";
    try (Connection conn = ConnectionFactory.getConnection()) {
    ...
    public void atualizar(Aluno aluno) throws SQLException {
        String sql = "UPDATE aluno SET cpf = ?, nome = ?, email = ?, data_nascimento = ?, curso_id = ? WHERE id = ?";

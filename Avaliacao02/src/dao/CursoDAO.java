...
public class CursoDAO {
    ...
    public boolean inserir(Curso curso) {
        String sql = "INSERT INTO curso (nome, carga_horaria, limite_alunos) VALUES (?, ?, ?)";
    ...
    public void atualizar(Curso curso) {
        String sql = "UPDATE curso SET nome = ?, carga_horaria = ?, limite_alunos = ? WHERE id = ?";
    ...
    public boolean podeCadastrarAluno(int idCurso) throws SQLException {
        ...
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            String sqlAlunos = "SELECT COUNT(*) FROM aluno WHERE curso_id = ?";
            ...
            String sqlLimite = "SELECT limite_alunos FROM curso WHERE id = ?";
